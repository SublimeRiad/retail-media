...
def _load_env():
    ...
    return env
_env = _load_env()
glpi_url, app_token, user_token = _env['GLPI_API_URL'], _env['GLPI_APP_TOKEN'], _env['GLPI_USER_TOKEN']
...
out_path = '/home/iots/.openclaw/workspace/iot-camera/rmstatus-push'
